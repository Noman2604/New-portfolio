...
const groups = [
  ...
  {
    label: "Backend",
    items: ["Next.js API Routes", "Node.js", "REST APIs", "Auth & RBAC"],
  },
  {
    label: "DataBase",
    items: ["MongoDB", "Mongoose", "Schema design", "Analytics pipelines"],
  },
  {
    label: "Project",
    items: ["AptiCore", "Hospital System", "Library System", "Expense Tracker "],
  },
];
